...
from tst.server.start_full_node import SERVICE_NAME
...
from tst.consensus.pot_iterations import calculate_iterations_quality
from tst.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
