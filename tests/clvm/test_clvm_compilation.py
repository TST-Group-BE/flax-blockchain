...
from tst.types.blockchain_format.program import Program, SerializedProgram

wallet_program_files = set(
    [
        "tst/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "tst/wallet/puzzles/cc.clvm",
        "tst/wallet/puzzles/tstlisp_deserialisation.clvm",
        "tst/wallet/puzzles/rom_bootstrap_generator.clvm",
        "tst/wallet/puzzles/generator_for_single_coin.clvm",
        "tst/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "tst/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "tst/wallet/puzzles/lock.inner.puzzle.clvm",
        "tst/wallet/puzzles/p2_conditions.clvm",
        "tst/wallet/puzzles/p2_delegated_conditions.clvm",
        "tst/wallet/puzzles/p2_delegated_puzzle.clvm",
        "tst/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "tst/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "tst/wallet/puzzles/p2_puzzle_hash.clvm",
        "tst/wallet/puzzles/rl_aggregation.clvm",
        "tst/wallet/puzzles/rl.clvm",
        "tst/wallet/puzzles/sha256tree_module.clvm",
        "tst/wallet/puzzles/singleton_top_layer.clvm",
        "tst/wallet/puzzles/did_innerpuz.clvm",
        "tst/wallet/puzzles/decompress_puzzle.clvm",
        "tst/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "tst/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "tst/wallet/puzzles/block_program_zero.clvm",
        "tst/wallet/puzzles/test_generator_deserialize.clvm",
        "tst/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
    ]
)

clvm_include_files = set(
    ["tst/wallet/puzzles/create-lock-puzzlehash.clvm", "tst/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "tst/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to tst/wallet/puzzles, but not added to `wallet_program_files`
        """
