...
from tst.cmds.configure import configure_cmd
from tst.cmds.farm import farm_cmd
from tst.cmds.init import init_cmd
from tst.cmds.keys import keys_cmd
from tst.cmds.netspace import netspace_cmd
from tst.cmds.plots import plots_cmd
from tst.cmds.show import show_cmd
from tst.cmds.start import start_cmd
from tst.cmds.stop import stop_cmd
from tst.cmds.wallet import wallet_cmd
...
@click.group(
    help=f"\n  Manage tst blockchain infrastructure ({__version__})\n",
    epilog="Try 'tst start node', 'tst netspace -d 192', or 'tst show -s'",
...
@cli.command("version", short_help="Show tst version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs tst daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from tst.daemon.server import async_run_daemon
    import asyncio
