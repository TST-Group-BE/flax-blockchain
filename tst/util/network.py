...
def class_for_type(type: NodeType) -> Any:
    if type is NodeType.FULL_NODE:
        ...
        from tst.introducer.introducer_api import IntroducerAPI
        ...
        from tst.farmer.farmer_api import FarmerAPI

        return FarmerAPI
    elif type is NodeType.HARVESTER:
        from tst.harvester.harvester_api import HarvesterAPI
