...
from tst.util.misc import format_minutes
...
async def summary(rpc_port: int, wallet_rpc_port: int, harvester_rpc_port: int, farmer_rpc_port: int) -> None:
    ...
    if amounts is not None:
        print(f"Total tst farmed: {amounts['farmed_amount'] / units['tst']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['tst']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['tst']}")
        print(f"Last height farmed: {amounts['last_height_farmed']}")
    else:
        print("Total tst farmed: Unknown")
    ...
    print("Note: log into your key using 'tst wallet show' to see rewards for each key")
